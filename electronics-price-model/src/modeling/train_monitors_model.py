...
def train_and_benchmark_monitor_models(data_path, models_dir):
    print("=" * 65)
    print("MONITOR PRICE REGRESSION: TRAINING & BENCHMARKING ENGINE")
    print("=" * 65)
    ...
    cat_cols = ['Brand_Cleaned', 'Resolution_Cleaned', 'Panel_Type', 'Condition_Cleaned', 'Location_Cleaned']
    num_cols = ['Size_Inches', 'Refresh_Rate_Hz', 'Is_Curved', 'Is_Gaming', 'Is_Frameless']
    ...
    for name, config in models.items():
        ...
        bundle_path = os.path.join(models_dir, f"monitor_{slug}.pkl")
    ...
    best_bundle_path = os.path.join(models_dir, "best_monitor_model.pkl")
    prod_bundle_path = os.path.join(models_dir, "monitor_production_model.pkl")
    rf_compat_path = os.path.join(models_dir, "random_forest_monitor_price.pkl")
...
if __name__ == "__main__":
    ...
    data_file = os.path.abspath(os.path.join(script_dir, "..", "..", "data", "processed", "monitors_cleaned.csv"))
    models_directory = os.path.abspath(os.path.join(script_dir, "..", "..", "models"))
    
    train_and_benchmark_monitor_models(data_file, models_directory)
